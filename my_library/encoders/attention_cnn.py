...
from ..utils.self_attn_utils import MultiHeadedAttention, PositionalEncoding
import logging
    ...
    def __init__(self,
        ...
        if self._output_dim:
            if not self._use_self_attention:
                ...
                self.projection_layer = Linear(maxpool_output_dim + (self._embedding_dim* self._sequence_length), 
                self._output_dim)
        else:
